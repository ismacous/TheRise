...
Ce qui est en place, et ce qui viendrait ensuite. Rien ici n'est une promesse de
date ; c'est l'ordre dans lequel les ajouts auraient le plus de valeur.
...
- **Guerre, sièges, PvP.** Le jeu est fait pour se détendre. Toute la tension
  vient de la gestion.
- **Monétisation, énergie, timers.** Aucun.
- **Réalisme graphique.** Le style low poly est un choix, pas une limite.
