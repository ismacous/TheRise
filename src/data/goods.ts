...
export interface GoodDef {
  ...
  /** Emoji-free glyph drawn by the UI icon atlas. */
  icon: string;
  color: string;
...
export const GOODS: Record<GoodId, GoodDef> = {
  ...
  iron_ore: def('iron_ore', 'Minerai de fer', 'Fer brut', 'raw', '⛏️', '#7d6a5b', 6, {
    carry: 4,
  ...
  flour: def('flour', 'Farine', 'Farine', 'refined', '🌫️', '#e8e0cd', 6, {
    carry: 8,
  ...
  candles: def('candles', 'Chandelles', 'Chandelles', 'comfort', '🕯️', '#f2e3a8', 14, {
    carry: 8,
    comfort: 1.0,
